# Claudinho for Non-Technical Users
...
Claudinho lets you use an AI coding assistant with different model providers such as:
...
After you run `claudinho`, the CLI should start and wait for your prompt.
